...
let price_samary =   document.querySelector(".all_price_summary .Subtotal .pruce .number").innerHTML;
...
function addToCart(cart){
    ...
    samaryPrice.innerHTML = calcTotalPrice();
       document.querySelector(".all_price_summary .Subtotal .pruce .number").innerHTML = calcTotalPrice()
        document.querySelector(".all_price_summary .Subtotal .All .number").innerHTML = calcTotalPrice()+30 
    updateCartCount();
    renderCheckout();
}
...
console.log( document.querySelector(".all_price_summary .Subtotal .All .number"))
